      ...
      <form
        ...
        >
          <div className="form-group">
            ...
            <input type="text" className="form-control" id="name" name="firstName" value={state.firstName} onChange={onChange}/>
          </div>
          <div className="form-group">
            <label htmlFor="last">Last Name</label>
            <input type="text" className="form-control" id="last" name="lastName" value={state.lastName} onChange={onChange}/>
          </div>
          <div className="mb-3">
            <label htmlFor="submission">Send me a message</label>
            <textarea name="submission" className="form-control" onChange={onChange} value={state.submission} ></textarea>
          </div>
