...
const SongDetail = ({song}) => {
  ...
  //fromt he first render, we will get na error because we cannot render null data!
...
//this function is how we get the current state: remember we aliased the cobination our reducers with keys? Well, that is how we can
//basically see our state and use it (the reducer will be called and return the current state of our selected song in this case)
//we invoke no actions here. unlike in the list component we had buttons to fire off actions
